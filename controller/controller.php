...
<head>
    ...
    <title>Controller Ulasan D'Tala</title>
</head>
    ...
    <div class="container mb-5">
        ...
        <figure>
            <blockquote class="blockquote">
                <p>Berisi Data Ulasan Dapur Tala.</p>
            </blockquote>
            <figcaption class="blockquote-footer">
                CRUD. <cite title="Source Title">Create, Read, Update, Delete.</cite>
            </figcaption>
        </figure>
        <a href="kelolaUlasan.php" type="button" class="btn btn-primary mb-3">
            ...
            <table id="dt" class="table align-middle table-bordered table-hover">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <?php echo $result['role_pelanggan']; ?>
                        </td>
                        <td>
                            <center>
                                <img class="rounded" style="max-height: 100px;"
                                    <?php if ($result['foto_pelanggan'] != ""){ ?>
                                    src="../assets/images/<?php echo $result['foto_pelanggan']; ?>">
                        ...
                        <td>
                            <?php echo $result['rate_pelanggan']; ?>
                        </td>
                        <td class="d-flex justify-content-center align-items-center" style="height: 100px;">
                            <center>
                                ...
                                <a href="kelolaUlasan.php?ubah=<?php echo $result['id_pelanggan']; ?>" type="button"
                                ...
                                <a href="proses.php?hapusUlasan=<?php echo $result['id_pelanggan']; ?>" type="button"
